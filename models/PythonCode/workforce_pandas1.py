...
# 
# Designed to be maintained in Jupyter Notebook to assist learning, it is converted to standard Python via : jupyter nbconvert --to script workforce_pandas.ipynb
...
#directory = '/Users/yanghy@us.ibm.com/Desktop/processed/CheapPhys'
#directory = '/Users/yanghy@us.ibm.com/Desktop/processed/Provheavy'
#directory = '/Users/yanghy@us.ibm.com/Desktop/processed/original'
directory = '/Users/yanghy@us.ibm.com/Desktop/processed/LimitedProvTypes'
#directory = '/Users/yanghy@us.ibm.com/Desktop/processed/TOLTest'

# The frames dictionary is used to create a indexed home for all the pandas data frames.  Their CSV file names, which were automatically generated from their sheet names by the Excel import service will then used as their panda names.
...
# This function returns an array containing the list of all the dataframes

# In[185]:


def get_dataframe_list():
    '''Returns an array containing the list of all the dataframes that have been loaded
    '''
    return sheets


# This function returns the dictionary containing the dataframes
...
# This function returns a dataframe of a given name
...
def get_dataframe(name):
    '''
    Returns a dataframe based on the name provided, if no dataframe of that name is present
